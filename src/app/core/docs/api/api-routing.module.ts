...
import {LintComponent} from "./lint/component/lint.component";
import {LINT_ROUTING} from "./lint/lint-routing.module";
...
export const API_ROUTING: Routes = [
  ...
  {path: "lint", component: LintComponent, children: LINT_ROUTING}
];
